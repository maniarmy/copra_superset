...
SECRET_KEY = 'uE6fYa60MyRJHN/kqimV8ZEKGZ2aU/0gzks16Gm70MvjzP/JneAav+oe'
...
EXTRA_CATEGORICAL_COLOR_SCHEMES = [
     {
         ...
         "isDefault": True,
         "colors":
          ['#00A651', '#1A8533', '#156327', '#79CA8C', '#A5DAAF', '#D2EDD8',
          '#D97706', '#92400E', '#4D2600', '#FBBF24', '#FDE68A', '#FEF3C7']
     }
     ]
...
MAPBOX_API_KEY = 'pk.eyJ1IjoibXNoaW5kaTEyMzQiLCJhIjoiY203YjFkbWM3MDZ6NjJqcXdrOTVqNXl5eiJ9.trj0cUJ4yNAXfeSmB4h98g'
